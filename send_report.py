...
class DingRobot:
    def __init__(self):
        self.allure = "http://admin:Aa123456@39.105.54.35:3000/job/郑嘉仪/allure/widgets/suites.json"
        ...
        if self.error > 0:
            ...
            content = {
                ...
                "link": {
                    ...
                    "title": "2" + datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'),
                    "picUrl": "",
                    "messageUrl": "http://admin:Aa123456@39.105.54.35:3000/job/郑嘉仪/allure"
                }
            }
